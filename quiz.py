...
original_questions = {
 ...
 'Método para convertir a mayúsculas':['upper()', 'toUpper()', 'to_upper()', 'upper_case()'],
 ...
 'Sintáxis correcta para crear una función':['def mi_funcion:', 'function mi funcion{}', 'def(mi_funcion{})', 'create mi_funcion()'],
 ...
 'Operador para división entera':['//', '%', '/', 'mod'],
